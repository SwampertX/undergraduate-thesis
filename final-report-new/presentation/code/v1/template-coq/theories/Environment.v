...
Module Environment (T : Term).
  ...
  | mi_abstract : module_implementation 
  | mi_algebraic : kername -> module_implementation
  | mi_struct : structure_body -> module_implementation
  | mi_fullstruct : module_implementation
  with structure_body :=
  | sb_nil
