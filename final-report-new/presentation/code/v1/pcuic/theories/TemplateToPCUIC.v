...
Definition trans_global_decl (d : kername × Ast.Env.global_decl) :=
  ...
  | Ast.Env.ConstantDecl bd =>
    [(kn, ConstantDecl (trans_constant_body bd))]
  | Ast.Env.InductiveDecl bd =>
    [(kn, InductiveDecl (trans_minductive_body bd))]
...
Definition trans_global_decls env (d : Ast.Env.global_declarations)
  : global_env_map
  := fold_right
  (fun decl Σ => fold_right add_global_decl Σ (trans_global_decl Σ decl))
  env d.
